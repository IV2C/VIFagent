DETECTION_PROMPT: str = """Detect the {label}, if present. Output a json list where each entry contains the 2D bounding box in "box_2d" and the label in "label". If not present, return an empty json list."""

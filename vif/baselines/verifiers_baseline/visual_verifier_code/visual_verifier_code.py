...
- Within this code, the variables initial_image and customized_image are already defined and available as OpenCV images.
- You must define a variable named code_result inside your code; its value will be returned as the result of eval_code.
...
def eval_code(code: str, initial_image, customized_image):
    ...
    globals = {"initial_image": initial_image, "customized_image": customized_image}

    exec(code, globals, loc)

    return loc["code_result"]

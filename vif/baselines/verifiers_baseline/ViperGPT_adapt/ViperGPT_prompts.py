...
class ImagePatch:
    ...
    def exists(self, object_name: str) -> bool:
        ...
        >>>     return is_foo and is_garply_bar
        """
    ...
    def verify_property(self, object_name: str, visual_property: str) -> bool:
        ...
        >>>     return letters_patches[0].verify_property("letters", "blue")
        """
...
Write a function using Python and the ImagePatch class (above) that could be executed to verify that a specified instruction has been applied on the image. 
